                        ...
                        <form action="" method="post" id="form-order">
                            <div class="data">
                                @foreach ($featuredPosts as $featuredPost)
                                    <div class="row post py-3" data-id="{{$featuredPost->post->id}}" data-order="{{$featuredPost->order}}" data-title="{{$featuredPost->post->title}}" data-order-id="{{$featuredPost->id}}">
                                        <input type="hidden" name="featuredPost[{{$featuredPost->order}}][post_id]" class="post-id" value="{{$featuredPost->post->id}}">
                                        <input type="hidden" name="featuredPost[{{$featuredPost->order}}][order]" class="post-order" value="{{$featuredPost->order}}">
                                        <input type="hidden" name="featuredPost[{{$featuredPost->order}}][id]" class="post-order" value="{{$featuredPost->id}}">
                                        <div class="col-1 post-index">{{$featuredPost->order}}</div>
