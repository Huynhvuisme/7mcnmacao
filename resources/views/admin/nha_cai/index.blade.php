                        ...
                        <div class="row mb-2">
                            <div class="col-4">
                                <select class="form-control" name="category_id" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                    <option value="/admin/nha_cai/1" {{$type == 1 ? 'selected' : ''}}>Top nhà cái sidebar</option>
                                    <option value="/admin/nha_cai/2" {{$type == 2 ? 'selected' : ''}}>Nhà cái uy tín</option>
                                    <option value="/admin/nha_cai/3" {{$type == 3 ? 'selected' : ''}}>Game đổi thưởng</option>
                                </select>
                            </div>
                        </div>
