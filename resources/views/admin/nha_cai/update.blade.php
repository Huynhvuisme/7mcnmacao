                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label>Mô tả</label>
                                                <textarea class="form-control context" name="content[description]" rows="4" placeholder="Mô tả">{{!empty($description) ? $description : ''}}</textarea>
                                            </div>
                                            @if($type == 2)
                                                <div class="form-group">
                                            ...
                                            @elseif($type == 3)
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="content[link_download]" value="{{!empty($link_download) ? $link_download : ''}}" type="text" placeholder="Link tải game">
                                                </div>
                                                <div class="form-group">
                                                    <label>Link xem review</label>
                                                    <input class="form-control" name="content[link_review]" value="{{!empty($link_review) ? $link_review : ''}}" type="text" placeholder="Link xem review">
