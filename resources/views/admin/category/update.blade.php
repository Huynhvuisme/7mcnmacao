                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            @php
                                                if (!empty($oneItem)) {
                                                    $title_child = json_decode($oneItem->title_children);
                                                }
                                            @endphp
                                            <div class="form-group">
                                                <label>Tiêu đề nhận định:</label>
                                                <input class="form-control"  name="title_children[nhanDinh]" value="{{!empty($title_child->nhanDinh) ? $title_child->nhanDinh : ''}}" type="text" placeholder="Tiêu đề nhận định">
                                            </div>
                                            <div class="form-group">
                                   
                                                <label>Tiêu đề tỷ lệ:</label>
                                                <input class="form-control"  name="title_children[tyLe]" value="{{!empty($title_child->tyLe) ? $title_child->tyLe : ''}}" type="text" placeholder="Tiêu đề tỷ lệ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
