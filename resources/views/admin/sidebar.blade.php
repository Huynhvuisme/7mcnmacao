    ...
    <ul class="c-sidebar-nav ps ps--active-y">
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown @if(getCurrentController() == 'post') c-show @endif">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                ...
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link {{ request()->is('admin/post/da-ga') ? 'c-active' : '' }}" href="/admin/post/featured-post"><span class="c-sidebar-nav-icon"></span> Bài viết nổi bật</a></li>
