...
<head>
    ...
    @if(!empty($seo_data['site_image']))
        <meta property="og:image" content="{{url($seo_data['site_image'])}}">
    @endif
    ...
    <link rel="shortcut icon" href="{{url('web/images/favicon.ico?2')}}" />
    <link rel="apple-touch-icon" href="{{url('web/images/favicon.ico?2')}}" />
...
<amp-analytics type="googleanalytics" config="https://amp.analytics-debugger.com/ga4.json" data-credentials="include">
    ...
    {
        "vars": {
            "GA4_MEASUREMENT_ID": "G-XK97WZNLZ0",
