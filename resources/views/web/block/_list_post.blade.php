...
<div class="col-7 col-lg-8">
    <h3 class="fs-20 fw-bold">
        <a href="{{getUrlPost($data)}}" title="{{$data->title}}" class="max-line-3 max-line-lg-1">{{$data->title}}</a>
    </h3>
    <div class="max-line-4 d-none d-lg-block font-14">{!! $data->description !!}</div>
</div>
