...
class PageController extends Controller
{
    ...
    {
        $pages = Page::select('id', 'title', 'slug')->orderBy('id', 'desc')->get();
        $dataExport = [];
        ...
        {
            $key++;
            $dataExport[$key]['id'] = $page->id;
            $dataExport[$key]['title'] = $page->title;
            $dataExport[$key]['slug'] = "$url/$page->slug-pt$page->id.html";
        }
        return collect($dataExport)->downloadExcel('page-tinh.xlsx');
    }
}
